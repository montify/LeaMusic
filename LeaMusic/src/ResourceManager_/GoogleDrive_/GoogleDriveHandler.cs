...
namespace LeaMusic.src.ResourceManager_.GoogleDrive_
{
    public class GoogleDriveHandler : IResourceHandler
    {
        ...
        public async Task<Project> LoadProject(Location projectLocation, LeaResourceManager resourceManager)
        {
            ...
            //var folder = context.CreateOrGetFolder("Test");

            //var subfolder = context.CreateOrGetSubfolder(folder, "lol");
            //var folderID = context.GetFolderIdByName("lol");
            ...
            //DeleteFolderRecursive(with subfolders)
