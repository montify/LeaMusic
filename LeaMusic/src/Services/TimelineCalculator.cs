namespace LeaMusic.Src.Services
{
    ...
    public class TimelineCalculator : ITimelineCalculator
    {
        ...
        public TimelineCalculator(IAudioEngine audioEngine, IViewWindowProvider viewWindowProvider)
        {
        ...
        )
        {
            ...
            {
                m_zoomMouseStartPosition = TimeSpan.FromSeconds(
                    ConvertPixelToSecond(
                        p.X,
                        viewStartTime.TotalSeconds,
        ...
        public double ConvertSecondToPixel(
        ...
        )
        {
            ...
            double relativePercentage =
                positionInViewSec.TotalSeconds / viewDurationSec.TotalSeconds;
        ...
        )
        {
            ...
            paddedEnd = TimeSpan.FromSeconds(
                Math.Min(totalDuration.TotalSeconds, paddedEnd.TotalSeconds)
            );
